...
export const typescriptRules = {
  ...
  /** Prevent @ts-ignore, allow @ts-expect-error freely */
  ...
  /** Enforces generic type convention: T or TFooBar */
  ...
  /** Checks if the explicit type is identical to the inferred type */
  ...
  /** Prefer ES6-style import declarations over triple-slash */
